...
theme.taglist_squares_sel   = path .. "/taglist/square_sel.png"
theme.taglist_squares_unsel = path .. "/taglist/square_unsel.png"
...
--theme.wallpaper = "/home/shivang/Pictures/flowers.jpg"
