...
batwidget = lain.widgets.bat({
    settings = function()
		...
		if bat_perc > 80 then
			widget:set_markup('<span color="#858585"> ' .. bat_perc .. ' </span>')
			battery_icon:set_image(path .. "/battery_full.png")
		elseif bat_perc > 40 then
			widget:set_markup('<span color="#858585"> ' .. bat_perc .. ' </span>')
			battery_icon:set_image(path .. "/battery_mid.png")
		elseif bat_perc > 20 then
			battery_icon:set_image(path .. "/battery_low.png")
			widget:set_markup('<span color="#858585"> ' .. bat_perc .. ' </span>')
		else
			widget:set_markup('<span color="#858585"> ' .. bat_perc .. ' </span>')
			battery_icon:set_image(path .. "/battery_low.png")
...
volume_widget = lain.widgets.alsa({
	settings = function()
		vol_level  = volume_now.level
		volume_icon:set_image(path .. "/volume.png")

		if volume_now.status == "off" then
			volume_icon:set_image(path .. "/volume.png")
			vol_level = vol_level .. "M "
		elseif type(vol_level) == "number" then
			if vol_level > 90 then
				volume_icon:set_image(path .. "/volume.png")
		...
		widget:set_markup('<span color="#858585">' .. vol_level .. '</span>')
	end 
})
